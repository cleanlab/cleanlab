from cleanlab.internal.token_classification_utils import get_sentence, filter_sentence, process_token, mapping, merge_probs, color_sentence 
...
def test_display_issues(): 
    ...
    display_issues(issues, words, pred_probs=pred_probs, given_labels=labels, class_names=class_names) 
...
def test_common_label_issues(): 
    ...
    common_label_issues(issues, words, labels=labels, pred_probs=pred_probs, class_names=class_names) 
