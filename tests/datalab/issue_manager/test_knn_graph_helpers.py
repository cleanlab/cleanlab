...
from cleanlab.datalab.internal.issue_manager.knn_graph_helpers import (
    _process_knn_graph_from_inputs,
...
class TestProcessKNNGraphFromInputs:
    def test_knn_graph_provided_in_kwargs(self):
        ...
        result = _process_knn_graph_from_inputs(kwargs, statistics, k_for_recomputation=5)
    ...
    def test_knn_graph_precedence_of_kwargs_over_statistics(self):
        ...
        result = _process_knn_graph_from_inputs(kwargs, statistics, k_for_recomputation=15)
        assert result.shape == (10, 10)
    ...
    def test_no_knn_graph_provided(self):
        ...
        kwargs = {"knn_graph": None}
        statistics = {"weighted_knn_graph": None}
        result = _process_knn_graph_from_inputs(kwargs, statistics, k_for_recomputation=0)
    ...
    def test_insufficient_knn_graph(self):
        ...
        kwargs = {"knn_graph": csr_matrix(np.random.random((10, 10)))}
        statistics = {"weighted_knn_graph": None}
        result = _process_knn_graph_from_inputs(kwargs, statistics, k)
        assert result.shape == (10, 10)
...
class TestSetKNNGraph:
    ...
    def small_knn_graph(self):
        knn_graph, _ = create_knn_graph_and_index(
            np.random.random((10, 5)), n_neighbors=5, metric="euclidean"
        )
        return knn_graph
    ...
    def mid_knn_graph(self):
        knn_graph, _ = create_knn_graph_and_index(
            np.random.random((10, 5)), n_neighbors=7, metric="euclidean"
        )
        return knn_graph
    ...
    def large_knn_graph(self):
        knn_graph, _ = create_knn_graph_and_index(
            np.random.random((10, 5)), n_neighbors=9, metric="euclidean"
        )
        return knn_graph
    ...
    def manhattan_knn_graph(self):
        knn_graph, _ = create_knn_graph_and_index(
            np.random.random((10, 5)), n_neighbors=5, metric="manhattan"
        )
        return knn_graph
    ...
    def test_knn_graph_stored_in_statistics(self, small_knn_graph):
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 4
        assert result_metric == "euclidean"
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 6
        assert result_metric == "euclidean"
    ...
    def test_knn_graph_precedence_of_kwargs_over_statistics(
        ...
        assert isinstance(result_graph, csr_matrix)
        assert num_neighbors_in_knn_graph(result_graph) == 7
        assert result_metric == "euclidean"
    ...
    def test_no_knn_graph_provided(self):
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 3
        assert result_metric == "cosine"

        with pytest.raises(
            AssertionError, match="Features must be provided to compute the knn graph."
        ):
            set_knn_graph(None, find_issues_kwargs, metric="cosine", k=0, statistics=statistics)
    ...
    def test_metric_change_requires_new_knn_graph(self, manhattan_knn_graph):
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 2
        assert result_metric == "euclidean"
    ...
    def test_knn_graph_with_insufficient_graph(self, small_knn_graph, large_knn_graph):
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 8
        ...
        assert num_neighbors_in_knn_graph(result_graph) == 9
        assert result_metric is "euclidean"
