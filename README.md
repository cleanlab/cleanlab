...
cleanlab helps you **clean** data and **lab**els by automatically detecting issues in a ML dataset. This data-centric AI package uses existing models to estimate dataset improvements that'll train better models, facilitating **machine learning with messy, real-world data**.
