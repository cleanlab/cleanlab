...
``cleanlab`` is a machine learning python package for **learning with noisy labels** and **finding label errors in datasets**. ``cleanlab`` CLEANs LABels. It is is powered by the theory of **confident learning**, published in  `this paper <https://arxiv.org/abs/1911.00068>`__ and explained in  `this blog <https://l7.curtisnorthcutt.com/confident-learning>`__. Using the `cgnorthcutt/confidentlearning-reproduce <https://l7.curtisnorthcutt.com/confident-learning>`__ repo, ``cleanlab`` v0.0.14 reproduces results in the `confident learning paper <https://arxiv.org/abs/1911.00068>`__.
