...
``cleanlab`` is a machine learning python package for **learning with noisy labels** and **finding label errors in datasets**. ``cleanlab`` CLEANs LABels.
...
Its called ``cleanlab`` because it CLEANs LABels. ``cleanlab`` is:
------------------------------------------------------------------
